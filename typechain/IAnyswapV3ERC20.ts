...
export interface IAnyswapV3ERC20Interface extends utils.Interface {
  functions: {
...
export interface IAnyswapV3ERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAnyswapV3ERC20Interface;
